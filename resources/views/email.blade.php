...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<table class="body" border="1">
                                            ...
                                            <td class="wrapper last">
                                                ...
                                                <table class="twelve columns">
                                                    <tr>
                                                        <td>
                                                            <p>Dear {{$registrant}}, </p>
                					    <p>Your participation to the Skill Enhancement Programme (SEP) scheduled on 9th and 10th October, 2015 has been confirmed.</p>
                                                            <p>List of confirmed speakers are uploaded at  <a href="http://skill.nitt.edu/">skill.nitt.edu</a></p>
                                                            <p>Still registration is OPEN. Pass on the information to your class mates and friends to participate and get benefited. No spot registration.</p>
                                                            <br>
                                                            <p>You are requested to assemble inside venue at NIT Trichy on 9th October, Friday at 8.30 am.</p>
                                                            <p>Venue of the programme will be updated shortly in the programme website. </p>
                                                            <p>Please, bring your Institute ID card and printout of the SEP-Registration form to collect the Programme kit and participation certificate.</p>
                                                            <br>
                                                            <p>NIT Trichy is located on Trichy - Tanjore NH road, 20 KM from Trichy Central Bus stand / Railway station and the travel time by bus will be approximately 40 minutes.</p>
                                                            <p>For any clarification feel free to call me.</p>
                                                        </td>
                                                        <td class="expander"></td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td class="wrapper last">
                                                ...
                                                <table class="twelve columns">
                                                    <tr>
                                                        <td align="center">
                                                            <center>
                                                            <p style="text-align:center;"><a href="tel:9865175135">98 651 751 35</a> | <a href="tel:9486001104">94 86 00 11 04</a> (Warden) | <a href="tel:04312503714">0431-250 3714</a> | <a href="mailto:marcon@nitt.edu">marcon@nitt.edu</a></p>
                                                            </center>
                                                        </td>
                                                        <td class="expander"></td>
                                                    </tr>
        ...
        <img src="http://www.google-analytics.com/collect?v=1&tid=UA-55334208-4&cid={{$id}}&t=event&ec=email&ea=open&el=recipient_id&cs=confirmation&cm=email&cn=SEP_NITT">
    </body>
</html>
